...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('register_task', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['register.Task'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.parent'
        db.delete_column('register_task', 'parent_id')
    ...
    models = {
        ...
        'register.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['register.Task']", 'null': 'True'}),
